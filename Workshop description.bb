...
At first glance, sm.interop does not seem to add much to the game. But appearances are deceptive.
sm.interop is a dependency for other mods, and it allows those mods to make complex scripted parts and custom tools,
that work together well with other mods that use sm.interop.

The mod consists of two parts: a workshop part and a game file part. The game file part needs to be installed manually.

Game file mods that change tools or scripts may not be compatible with sm.interop. However, most of those mods can be re-written to work together with sm.interop.
If you are a developer of a game file mod and need help with rewriting your mod to work with sm.interop, do not hesitate to contact Xesau#1681 on Discord.
